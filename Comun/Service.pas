...
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?wsdl>0
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?xsd=xsd0
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?xsd=xsd2
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?xsd=xsd3
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?xsd=xsd4
//  >Import : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc?xsd=xsd1
// Encoding : utf-8
// Version  : 1.0
// (17/09/2018 02:31:59 p. m. - - $Rev: 90173 $)
// ************************************************************************ //
...
type
  ...
  // URL       : http://demoemision.thefactoryhka.com.co/ws/obj/v1.1/Service.svc
  // ************************************************************************ //
  IService = interface(IInvokable)
  ['{98ED6C0B-93D7-7F02-40EA-9A0E061E5A66}']
    function  Enviar(const tokenEmpresa: string; const tokenPassword: string; const factura: FacturaGeneral2; const adjuntos: string): DocumentResponse2; stdcall;
...
initialization
  ...
  InvRegistry.RegisterParamInfo(TypeInfo(IService), 'Enviar', 'adjuntos', '',
                                '', IS_NLBL);
